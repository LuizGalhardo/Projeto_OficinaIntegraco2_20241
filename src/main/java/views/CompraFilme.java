...
public class CompraFilme extends javax.swing.JFrame {

    private static CompraFilme gerItemUnico;

    public static CompraFilme getEdicaoItem() {
        if (gerItemUnico == null) {
            gerItemUnico = new CompraFilme();
        }
        return gerItemUnico;
    }
    ...
    private void initComponents() {
        ...
        lblDesc.setText("FORMA DE PAGAMENTO");

        txtDescricao.setColumns(20);
        txtDescricao.setRows(5);
        txtDescricao.setText("COLOCAR UMA SELECAO IGUAL A DE BAIXO");
        ...
        txtSituacao.setText("TIPO USUARIO");
